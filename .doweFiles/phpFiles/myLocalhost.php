...
<link rel="icon" type="image/x-icon" href="/.global/assets/images/favicon/favicon.ico">
<?php
//Default Configuration
// $CONFIG = '{"lang":"en","error_reporting":false,"show_hidden":false,"hide_Cols":false,"calc_folder":false,"theme":"light"}';
$securityInclude = FALSE;
	
	if($securityInclude == true){
		$includedFiles = [
			'security/config.php',
			'security/project-security.php',
		];
...
$auth_users = array(
	...
	'mrjohndowe' => '$2y$10$hXCqjUqHwa5/nGl8eNuiGeVE6jrn9bWe9MzOnVF1TZCEVlUk5A1nq',
	'sierrabraunns1920' => '$2y$10$pCORDYPbC7jJPByMncVm4.HMWHx0Tm/5i3Tcrn8BRyZ0IU2LtUM3O',
);
...
$exclude_items = array('myLocalhost.php','.phpLiteAdmin.OLD','.htaccess','Special','security');
           ...
           $root_url .= '
            ...
            <div class="col-xs-6 col-sm-7 text-right">
                <ul class="navbar-nav mr-auto float-right <?php echo fm_get_theme();  ?>">
					...
					<li class="nav-item">
                        <a title="<?php echo lng('security') ?>" class="nav-link" href="/security" target="_blank"><i class="fa fa-shield" aria-hidden="true"></i> <?php echo lng('security') ?></a>
                	</li>
...
<?php if (isset($_GET['edit']) && isset($_GET['env']) && FM_EDIT_FILE):
    ...
    <script>
        ...
        editor.setTheme("ace/theme/tomorrow_night_bright"); //Dark Theme
